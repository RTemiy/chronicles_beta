...
var URLS = [
  ...
  //Pictures
    ...
    `${GHPATH}/pictures/Backgrounds/Camp_Morning.png`,
    `${GHPATH}/pictures/Backgrounds/Camp_Night.png`,
    ...
    `${GHPATH}/pictures/Backgrounds/Colorado.png`,
    ...
    `${GHPATH}/pictures/Backgrounds/Horseriding.png`,
    `${GHPATH}/pictures/Backgrounds/Horses_Meadow.png`,
    `${GHPATH}/pictures/Backgrounds/House_Immortals.png`,
    ...
    `${GHPATH}/pictures/Backgrounds/Legend_Scene_01.png`,
    `${GHPATH}/pictures/Backgrounds/Legend_Scene_02.png`,
    `${GHPATH}/pictures/Backgrounds/Legend_Scene_03.png`,
    `${GHPATH}/pictures/Backgrounds/Legend_Scene_04.png`,
    `${GHPATH}/pictures/Backgrounds/Legend_Scene_05.png`,
    `${GHPATH}/pictures/Backgrounds/Legend_Scene_06.png`,
    `${GHPATH}/pictures/Backgrounds/Legend_Scene_07.png`,
    `${GHPATH}/pictures/Backgrounds/Leon_Bike.png`,
    `${GHPATH}/pictures/Backgrounds/Livingroom.png`,
    `${GHPATH}/pictures/Backgrounds/Mine.png`,
    ...
    `${GHPATH}/pictures/Backgrounds/Saloon.png`,
    ...
    `${GHPATH}/pictures/Backgrounds/WildWest_Portal.png`,
    ...
    `${GHPATH}/pictures/Covers/SixPart.png`,
    ...
    `${GHPATH}/pictures/Persons/Curtis_01.png`,
    `${GHPATH}/pictures/Persons/Curtis_02.png`,
    `${GHPATH}/pictures/Persons/Curtis_03.png`,
    `${GHPATH}/pictures/Persons/Dog_Dirty.png`,
    `${GHPATH}/pictures/Persons/Dog_Dry.png`,
    `${GHPATH}/pictures/Persons/Goddess.png`,
    `${GHPATH}/pictures/Persons/Goddess_Scars.png`,
    ...
    `${GHPATH}/pictures/Persons/Mother_PP.png`,
    ...
    `${GHPATH}/pictures/Persons/Robert_Colorado.png`,
  ...
  `${GHPATH}/pictures/Interface/loadingscreen.png`
  ]
