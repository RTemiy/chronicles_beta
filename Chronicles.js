...
Game.Stats.GoToLakeWith = new Stat({
    type: 'Choice',
...
Game.Scenes.FifthPart[124] = new Scene({
  text: `
            Меня раздражает его манера речи, постоянные недомолвки и буквально все. По прошествии всех событий, я никак не могу относится к нему с пониманием, которое он требует.
            `,
  background: "Persons/Stranger",
  buttontext: [''],
...
Game.Scenes.FifthPart[168] = new Scene({
  text: `
     ...
     Дойдя до конечной точки - плеча, он аккуратно обернул круг и задержался в непосредственной близость от моей шеи, раздумывая.
            `,
  background: "Persons/Neitan_New",
  buttontext: [''],
...
Game.Scenes.FifthPart[202] = new Scene({
  text: `
    ...
    <p>“Не задерживайся, у меня всего одна сигарета :)”
            `,
  background: "Backgrounds/Room",
  buttontext: [''],
...
Game.Scenes.FifthPart[207] = new Scene({
  text: `
     - Не могу поверить, ты и правда сделал это! Даже не представляю, как бы на это отреагировала Скарлетт, ведь она всерьез переживает за тебя. Что же до меня, то я поддерживаю твое решение и не только потому, что мечтаю на нем прокатится, - сказала я, искренне улыбаясь.
...
Game.Scenes.FifthPart[218] = new Scene({
  text: `
       ...
       У них в меню есть супер сочный бургер. Я как-то узнавал их секрет, оказалось, они используют для приготовления аж 4 вида мяса, представляешь!
            `,
  background: "Backgrounds/Lake",
  buttontext: [''],
...
Game.Scenes.FifthPart[229] = new Scene({
  text: `
        Я поставила руки в бок, подняв высоко голову и закрыв глаза. 
...
Game.Scenes.FifthPart[239] = new Scene({
  text: `
        ...
        <p>- Мы есть у друг друга, - я завороженно смотрела на Леона. - Давай строить настоящее, а не зацикливаться на прошлом. 
            `,
  background: "Persons/Leon_New",
  buttontext: [''],
...
Game.Scenes.FifthPart[253] = new Scene({
  text: `
        Я решила разрядить обстановку и игриво толкнула Леона в плечо, говоря следующее:
...
Game.Scenes.FifthPart[259] = new Scene({
  text: `
        ...
        <p>Я спросила: 
            `,
  background: "Persons/Leon_New",
  buttontext: ['Что же на самом деле происходит между тобой и Нэйтаном?','Кем ты работаешь?' ,'Расскажешь о своих планах на будущее?'],
  buttonaction: [
...
Game.Scenes.FifthPart[273] = new Scene({
  text: `
        ...
        <p>Вскоре, Леон ушел в сторону мотоцикла, давая мне немного времени, чтобы побыть наедине. 
            `,
  background: "Backgrounds/Lake",
  buttontext: [''],
